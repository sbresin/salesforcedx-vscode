...
export class WebviewService {
  ...
  public async createOrShowWebview() {
    ...
    if (this.panel) {
      ...
      this.panel.reveal(previewColumn, preserveFocus);
  ...
  private async getHtmlForWebview(webview: vscode.Webview) {
    ...
    return `<!DOCTYPE html>
            ...
            <head>
                ...
                -->
                <meta http-equiv="Content-Security-Policy" content="default-src 'none'; frame-src https://online.visualstudio.com ${fullWebServerUri}; img-src ${webview.cspSource} https:; script-src 'nonce-${nonce}'; style-src 'unsafe-inline';">
